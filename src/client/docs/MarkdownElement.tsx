...
marked.Lexer.prototype.lex = function lex(src: string) {
  src = src
    .replace(/\r\n|\r/g, '\n')
    .replace(/\t/g, '    ')
    .replace(/\u2424/g, '\n');
...
const markedOptions = {
  ...
  highlight(code: string, lang: string) {
    ...
    return prism.highlight(code, language || prism.languages.javascript);
  },
  renderer,
};
...
export default withStyles(muiStyles)(MarkdownElement);
