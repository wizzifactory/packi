...
import { isImage } from '../../features/filelist/fileUtilities';
import { AssetFileEntry } from '../../features/filelist/types';
    ...
    return (
      <div className={css(styles.container)}>
        <div className={css(styles.inner)}>
          {isImage(this.props.entry.item.path) ? (
            <img
          ...
          <h4 className={css(styles.name)}>{this.props.entry.item.path.split('/').pop()}</h4>
